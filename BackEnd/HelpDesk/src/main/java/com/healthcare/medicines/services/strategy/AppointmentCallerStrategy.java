...
public class AppointmentCallerStrategy implements NetworkStrategy {
    private final InternalCaller internalCaller = new InternalCaller(Endpoints.APPOINTMENT_SEARCH);
    @Override
