...
public class CommunityCallerStrategy implements NetworkStrategy {
    private final InternalCaller internalCaller = new InternalCaller(Endpoints.COMMUNITY_SEARCH);
    @Override
