              ...
              <CardHeader className="bg-transparent">
                <Row className="align-items-center">
                  <div className="col">
                    ...
                    <h2 className="text-white mb-0">Set schedules {selectedDate && <>for {selectedDate}</>}</h2>
                  </div>
                </Row>
              </CardHeader>
              <CardBody>
                {selectedDate ? (
                  <>
                    <div className="m-2 p-2" style={{border: "1px solid #558"}}>
                    <FormGroup check className="m-3">
                      <h2><Label check className="text-white">
                        <Input
                          type="checkbox"
                          checked={scheduleData.morning === 1 || scheduleData.morning === 2}
                          onChange={() =>
                    ...
                    <FormGroup check className="m-3">
                      ...
                      <Col>
                      <FormGroup>
                      <Label for="morningCapacity"><div className="text-white">Capacity</div></Label>
                      <Input
                        type="number"
                        id="morningCapacity"
                    ...
                    <FormGroup check className="m-3">
                      <h2><Label check className="text-white">
                        <Input
                          type="checkbox"
                          checked={scheduleData.afterNoon === 1 || scheduleData.afterNoon === 2}
                          onChange={() =>
                            setScheduleData((prevData) => ({
                              ...prevData,
                    ...
                    <FormGroup check className="m-3">
                      <h2><Label check className="text-white">
                        <Input
                          type="checkbox"
                          checked={scheduleData.evening === 1 || scheduleData.evening === 2}
                          onChange={() =>
                            setScheduleData((prevData) => ({
                              ...prevData,
                  ...
                  <h3 className="text-white mb-0">Select a date from the left</h3>
                )}
              </CardBody>
            </Card>
          </Col>
